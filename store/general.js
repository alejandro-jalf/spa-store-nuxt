  ...
  listTabs: [
    ...
    },
    {
      ...
      childrens: [
        ...
        {
          path: '/comparativaventas',
          name: 'comparativaventas',
          nickname: 'Estadistica',
          icon: 'graph-up',
        },
        {
          path: '/ventasporarticulo',
          name: 'ventasporarticulo',
          nickname: 'Por Articulo',
          icon: 'graph-up',
        },
      ],
      name: '',
    ...
    },
    {
      ...
      childrens: [
        ...
        {
          path: '/movimientostortillas',
          name: 'movimientostortillas',
          nickname: 'Tortillas',
